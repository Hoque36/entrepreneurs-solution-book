# entrepreneurs-solution-book

All-in-one business operations dashboard for new Bangladeshi entrepreneurs — track leads, sales, income/expenses, tasks, marketing, compliance, and growth KPIs from a single web app.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "327940837+Hoque36@users.noreply.github.com"
  git config user.name "Hoque36"
  ```
